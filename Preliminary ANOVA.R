...
App.model <- lm(data = All, Appropriateness~ (Context + `User Status` + Product + Order + Order*Product + Context*Product))
...
App.model.freq.panel <- lm(data = Users_freq, Appropriateness~ (Panelist + Product + Order + Order*Product + Context*Product))
options(contrasts = c("contr.sum", "contr.poly"))
App.aov.freq.panel <-  Anova(App.model.freq.panel,type = "III")
print(App.aov.freq.panel)

HSD.test(App.model.freq.panel, "Context", console = TRUE)
...
HSD.test(App.model.infreq, "Context", console = TRUE)

#Infreq User Model + Panelist Effect - Context 
App.model.infreq.panel <- lm(data = Users_infreq, Appropriateness~ (Panelist + Product + Order + Order*Product + Context*Product))
options(contrasts = c("contr.sum", "contr.poly"))
App.aov.infreq.panel <-  Anova(App.model.infreq.panel,type = "III")
print(App.aov.infreq.panel)

HSD.test(App.model.infreq.panel, "Context", console = TRUE)



##Liking
#Full Data Set Model - Panelist Effect
Like.model <- lm(data = All, Liking~ (Context + `User Status`+ Product + Order + Order*Product + Context*Product))
options(contrasts = c("contr.sum", "contr.poly"))
...
#Freq User Model + Panelist Effect - Context 
Like.model.freq.panel <- lm(data = Users_freq, Liking~ (Panelist + Product + Order + Order*Product + Context*Product))
options(contrasts = c("contr.sum", "contr.poly"))
Like.aov.freq.panel <-  Anova(Like.model.freq.panel,type = "III")
print(Like.aov.freq.panel)

HSD.test(Like.model.freq.panel, "Context", console = TRUE)

#Infreq User Model - Panelist Effect
Like.model.infreq <- lm(data = Users_infreq, Liking~ (Context + Product + Order + Order*Product + Context*Product))
options(contrasts = c("contr.sum", "contr.poly"))
...
#Infreq User Model + Panelist Effect - Context 
Like.model.infreq.panel <- lm(data = Users_infreq, Liking~ (Panelist + Product + Order + Order*Product + Context*Product))
options(contrasts = c("contr.sum", "contr.poly"))
Like.aov.infreq.panel <-  Anova(Like.model.infreq.panel,type = "III")
print(Like.aov.infreq.panel)

HSD.test(Like.model.infreq.panel, "Context", console = TRUE)
